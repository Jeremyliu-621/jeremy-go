    ...
    <div className="absolute inset-0 overflow-hidden" aria-hidden>
      ...
      <div
        ...
        style={{
          height: '52%',
          background: `
            repeating-linear-gradient(92deg, rgba(80,160,50,0.08) 0px, transparent 2px, transparent 18px),
            repeating-linear-gradient(88deg, rgba(40,120,30,0.06) 0px, transparent 1px, transparent 24px)
          `,
        }}
      />
